...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yonjzpt1kr">Show
  modal</button>

<div data-modal id="modal-yonjzpt1kr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yonjzpt1kr-label" aria-describedby="modal-yonjzpt1kr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yonjzpt1kr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yonjzpt1kr-heading">Modal heading</p>
