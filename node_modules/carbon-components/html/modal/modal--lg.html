...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kmm6s1lsgfd">Show
  modal</button>

<div data-modal id="modal-kmm6s1lsgfd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kmm6s1lsgfd-label" aria-describedby="modal-kmm6s1lsgfd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kmm6s1lsgfd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kmm6s1lsgfd-heading">Modal heading</p>
