...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-aisg15a2lcg">Show
  modal</button>

<div data-modal id="modal-aisg15a2lcg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-aisg15a2lcg-label" aria-describedby="modal-aisg15a2lcg-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-aisg15a2lcg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-aisg15a2lcg-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
