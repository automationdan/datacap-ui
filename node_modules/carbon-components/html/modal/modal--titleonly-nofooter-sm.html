...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mt0y122ei2">Show
  modal</button>

<div data-modal id="modal-mt0y122ei2" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mt0y122ei2-label" aria-describedby="modal-mt0y122ei2-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mt0y122ei2-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mt0y122ei2-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
