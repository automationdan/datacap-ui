...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lrh3lmizkdf">Show
  modal</button>

<div data-modal id="modal-lrh3lmizkdf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lrh3lmizkdf-label" aria-describedby="modal-lrh3lmizkdf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lrh3lmizkdf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lrh3lmizkdf-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
