...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gmub43q79nv">Show
  modal</button>

<div data-modal id="modal-gmub43q79nv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gmub43q79nv-label" aria-describedby="modal-gmub43q79nv-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gmub43q79nv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gmub43q79nv-heading">Modal heading</p>
