...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pn07u2cg03h">Show
  modal</button>

<div data-modal id="modal-pn07u2cg03h" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pn07u2cg03h-label" aria-describedby="modal-pn07u2cg03h-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pn07u2cg03h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pn07u2cg03h-heading">Modal heading</p>
