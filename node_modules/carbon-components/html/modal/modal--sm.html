...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eakb20ve6xf">Show
  modal</button>

<div data-modal id="modal-eakb20ve6xf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eakb20ve6xf-label" aria-describedby="modal-eakb20ve6xf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eakb20ve6xf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eakb20ve6xf-heading">Modal heading</p>
