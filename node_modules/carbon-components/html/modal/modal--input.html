...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-l9o3ot9r5b">Show
  modal</button>

<div data-modal id="modal-l9o3ot9r5b" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-l9o3ot9r5b-label" aria-describedby="modal-l9o3ot9r5b-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-l9o3ot9r5b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-l9o3ot9r5b-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-l9o3ot9r5b" class="bx--label">Text Input label</label>
        <input id="text-input-l9o3ot9r5b" type="text" class="bx--text-input" placeholder="Optional placeholder text"
