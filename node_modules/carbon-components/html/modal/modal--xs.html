...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lcpwewhe2gm">Show
  modal</button>

<div data-modal id="modal-lcpwewhe2gm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lcpwewhe2gm-label" aria-describedby="modal-lcpwewhe2gm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lcpwewhe2gm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lcpwewhe2gm-heading">Modal heading</p>
