...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-9l9706032lu">Show
  modal</button>

<div data-modal id="modal-9l9706032lu" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-9l9706032lu-label" aria-describedby="modal-9l9706032lu-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9l9706032lu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9l9706032lu-heading">Modal heading</p>
