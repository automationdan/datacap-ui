...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-htevb2dzdo">Show
  modal</button>

<div data-modal id="modal-htevb2dzdo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-htevb2dzdo-label" aria-describedby="modal-htevb2dzdo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-htevb2dzdo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-htevb2dzdo-heading">Modal heading</p>
