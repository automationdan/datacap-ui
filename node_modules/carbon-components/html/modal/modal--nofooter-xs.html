...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qtlqyz6usxh">Show
  modal</button>

<div data-modal id="modal-qtlqyz6usxh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qtlqyz6usxh-label" aria-describedby="modal-qtlqyz6usxh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qtlqyz6usxh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qtlqyz6usxh-heading">Modal heading</p>
