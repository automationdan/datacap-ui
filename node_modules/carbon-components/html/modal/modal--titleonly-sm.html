...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eksykxh21sn">Show
  modal</button>

<div data-modal id="modal-eksykxh21sn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eksykxh21sn-label" aria-describedby="modal-eksykxh21sn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eksykxh21sn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eksykxh21sn-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
