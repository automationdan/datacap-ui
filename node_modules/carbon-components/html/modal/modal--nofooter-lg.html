...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-p0jyymfgbu">Show
  modal</button>

<div data-modal id="modal-p0jyymfgbu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-p0jyymfgbu-label" aria-describedby="modal-p0jyymfgbu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-p0jyymfgbu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-p0jyymfgbu-heading">Modal heading</p>
