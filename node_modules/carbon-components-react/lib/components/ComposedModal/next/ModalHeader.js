...
var _excluded = ["className", "labelClassName", "titleClassName", "closeClassName", "closeIconClassName", "label", "title", "children", "iconDescription", "closeModal", "buttonOnClick", "preventCloseOnClickOutside"];
...
function ModalHeader(_ref) {
  ...
  var headerClass = (0, _classnames.default)((_cx = {}, (0, _defineProperty2.default)(_cx, "".concat(prefix, "--modal-header"), true), (0, _defineProperty2.default)(_cx, className, className), _cx));
