...
var ComposedModal = /*#__PURE__*/_react.default.forwardRef(function ComposedModal(_ref, ref) {
  ...
  var modalClass = (0, _classnames.default)((_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--modal"), true), (0, _defineProperty2.default)(_classNames, 'is-visible', isOpen), (0, _defineProperty2.default)(_classNames, className, className), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--modal--danger"), danger), _classNames));
  var containerClass = (0, _classnames.default)((_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(prefix, "--modal-container"), true), (0, _defineProperty2.default)(_classNames2, "".concat(prefix, "--modal-container--").concat(size), size), (0, _defineProperty2.default)(_classNames2, containerClassName, containerClassName), _classNames2)); // Generate aria-label based on Modal Header label if one is not provided (L253)
